...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title> نظام الادارة العامة للقبول بالوزارة</title>
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <h2>مرحبا بكم في نظام الادارة العامة للقبول بوزارة التعليم العالي(السودان)</h2>
                        <p class="mt-4"> @if (Route::has('login'))
                <div class="border-t border-gray-200 dark:border-gray-700 text-center"> 
